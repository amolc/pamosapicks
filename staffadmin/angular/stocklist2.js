app.controller('stocklist-ctrl', function($scope, $http, $window,$location, config) {
  ...
  $scope.addstockdata = function(data) {
    console.log("add stcok called");
    console.log(data,"..data",data.source,"....",data.stock);
    if (typeof data.source === 'undefined'){
      console.log("null called stcok called");
      // data.source = "NASDAQ" 
       data.source = ""
    ...
    if (typeof data.telegram === 'undefined'){
      console.log("null called stcok called");
      data.telegram = "999999999"

    }
    if (typeof data.whatsapp === 'undefined'){
      console.log("null called stcok called");
      data.whatsapp = "999999999"
