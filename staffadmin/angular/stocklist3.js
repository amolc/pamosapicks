app.controller(
  ...
  $scope.getportfoliostocks = function(modelportfolioId) {
    ...
    console.log(data);
      var urlconfig = {
        ...
        $http
          .get( $scope.baseurl + "modelportfolio/stocks"  , urlconfig)
          .success(function (data, status, headers, config) {
  ...
  $scope.onaddstockSubmit = function (data) {
    ...
    $scope.addstock = {}
    data.modelportfolio_id = data.selectedPortfolio ;

  
    data.modelportfolio_id = data.selectedPortfolio;
    data.modelportfolio_name = data.selectedPortfolioName;
    // data.modelportfolio_id 
    var parts = data.modelportfolio_id.split(':');
    data.modelportfolio_id = parts[0];
    data.modelportfolio_name = parts[1];
    ...
    // debugger
      var urlconfig = {
        ...
        $http
          .post( $scope.baseurl + "modelportfolio/stocks", data, urlconfig)
          .success(function (data, status, headers, config) {
