...
$scope.registerCustomer = async function() {
    ...
    const userData = {
      ...
      country: $scope.order_data.country,
      state: $scope.order_data.state,
      billing_address: $scope.order_data.billing_address,
      billing_address2: $scope.order_data.billing_address2,
