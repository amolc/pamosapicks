app.controller(
  ...
  function ($scope, $http, $window, $location, config) {
    ...
    $scope.init = function (req, res) {
      ...
      $scope.data.endpoint = "https://paper-api.alpaca.markets";
      $scope.data.apiid = "PKJMVCT3SM87K0S7GVE4";
      $scope.data.investment_amount = "100000.00";
      $scope.data.cost = 1;
      $scope.data.package = "Annual";
      $scope.data.secertkey = "1CyemheDKAdv56PIxI1i18pX7vk8wRnvwdfjHF3c";

      localStorage.setItem("cost" , 1);
      localStorage.setItem("package" , "Annual");
      localStorage.setItem("tenure","Annual");
      localStorage.setItem("investment_amount",100000);
    ...
    //       $scope.data.phone = localStorage.getItem("endpoint");
    //       $scope.data.phone = localStorage.getItem("key");
    //       $scope.data.phone = localStorage.getItem("secret");
    //       $scope.data.phone = localStorage.getItem("capital");
    //       // debugger
    ...
    $scope.previous = function (req, res) {
      location.href = "/alpaca-plans.html";
    };
    ...
    $scope.confirm = function (data) {
      ...
      localStorage.setItem("portfolioname", data.portfolio_name),
      ...
      location.href = "/alpaca-confirmation.html";
    };
    ...
    //   localStorage.setItem('endpoint', req.endpoint);
    //   localStorage.setItem('apiid', req.apiid);
    //   localStorage.setItem('key', req.key);
    //   localStorage.setItem('capital', req.capital);
    //   // debugger
      
    //   location.href = "/app/alpaca-confirmation.html";
    // };
