...
function setOutcome(result) {
  ...
  if (result.token) {
    ...
    var today = new Date();
     ...
     $scope.data.username = localStorage.getItem("aliceblueusername");
     $scope.data.password = localStorage.getItem("alicebluepassword");
     $scope.data.apikey = localStorage.getItem("apikey");
     $scope.data.secret_key = localStorage.getItem("secretkey");
    ...
    $http
         .post(
           $scope.baseurl + "stockdata/savealicebluerobotportfolio",
           $scope.data,
           urlconfig
         )
         .success(function (response, status, headers, config) {
