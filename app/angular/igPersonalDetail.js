app.controller(
  ...
  function ($scope, $http, $window, $location, config) {
    ...
    $scope.confirm = function (data) {
      ...
      // localStorage.setItem('secertkey', req.secertkey);
      // localStorage.setItem('portfolioName', req.igusername);
      // localStorage.setItem('igusername', req.igusername);
      // localStorage.setItem('igpassword', req.igpassword);
      // localStorage.setItem('apikey', req.apikey);
      // localStorage.setItem('apitype', req.apitype);
      // localStorage.setItem('apistatus', req.apistatus);

      // debugger
      
      location.href = "/app/ig-confirmation.html";
    };
