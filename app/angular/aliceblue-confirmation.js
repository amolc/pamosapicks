app.controller(
  ...
  function ($scope, $http, $window, $location, config) {
    ...
    $scope.init = function (req, res) {
      ...
      $scope.data.aliceblueusername = localStorage.getItem("aliceblueusername");
      $scope.data.alicebluepassword = localStorage.getItem("alicebluepassword");
      $scope.data.apikey = localStorage.getItem("apikey");
      $scope.data.secretkey = localStorage.getItem("secretkey");
      $scope.data.twofa = localStorage.getItem("twofa");
      // debugger
    ...
    $scope.previous = function (req, res) {
      location.href = "/app/aliceblue-personaldetail.html";
    }

    $scope.confirm = function (req, res) {
      location.href = "/app/aliceblue-payment.html";
    }
