app.controller(
  ...
  function ($scope, $http, $window, $location, config) {
    ...
    $scope.confirm = function (req, res) {
      ...
      localStorage.setItem('aliceblueusername', req.aliceblueusername);
      localStorage.setItem('alicebluepassword', req.alicebluepassword);
      localStorage.setItem('apikey', req.apikey);
      localStorage.setItem('secretkey', req.secretkey);
      localStorage.setItem('twofa', req.twofa);
      // debugger
      
      location.href = "/app/aliceblue-confirmation.html";
    };
