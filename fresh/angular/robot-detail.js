app.controller('robot-detail-ctrl', function($scope, $http, $window, $location, $sce, $timeout, store, config) {
    ...
    $scope.init = function (req, res) {
        ...
        $scope.getStockSignals(stock,source);
        
      };


      $scope.getStockSignals = function (stock,source) {
        console.log($scope.url =
          config.baseurl + `stockdata/signals/?stock=${stock}&source=${source}`,".....")
        var urlconfig = {
          headers: {
