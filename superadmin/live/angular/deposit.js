...
app.controller(
      ...
      $scope.getCustomerBalance = function (customerId) {
        ...
        $http.post($scope.getbalanceurl ,$scope.data)
          .success(function (response, status) {
            ...
            $scope.c = $scope.balancedata.cash_balance
    ...
    $scope.getDeposits = function (req, res) {
        ...
        $scope.getdepositsurl = $scope.baseurl + variable.bankmodule + "/getDepositbyCustomerId" ;
    ...
    $scope.getAgents = function (req, res) {
      ...
      $scope.addDeposits = function (depositform) {
        ...
        if ($scope.validateentry == 1){ 
            ...
            $http.post($scope.baseurl + variable.bankmodule + "/addDepositView", $scope.data, $scope.config)
                .success(function (response, status) {
                    console.log(response);
                    $scope.getDeposits()
