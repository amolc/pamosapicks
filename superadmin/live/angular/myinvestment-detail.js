...
app.controller(
  ...
  function ($scope, $http, $window, $location, config, variable) {
    ...
    $scope.editportfolio = function (data) {
      ...
      $scope.data.portfolio_name = $scope.portfolioDetails.portfolio_name
      ...
      $scope.data.portfolio_order_by = $scope.portfolioDetails.portfolio_order_by
      $scope.data.portfolio_min_capital = $scope.portfolioDetails.portfolio_min_capital
      $scope.data.portfolio_info = $scope.portfolioDetails.portfolio_info
