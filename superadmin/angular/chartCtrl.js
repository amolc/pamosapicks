app.controller('chartCtrl', function ($scope, $http, $window, $location, $interval, config) {
  ...
  $scope.charturl = $scope.baseurl + "adx/supertrendchart?name=" + stockdata;
  $scope.buysellsignalsurl = $scope.baseurl + "adx/buysellsignals?name=" + stockdata;
  $scope.profitlosssurl = $scope.baseurl + "adx/profitloss?name=" + stockdata;
  $scope.signalsurl = $scope.baseurl + "adx/sendstocksignal?name=" + stockdata;
