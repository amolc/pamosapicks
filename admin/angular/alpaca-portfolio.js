app.controller('alpaca-portfolio-ctrl', function($scope, $http, $window, $location, $sce, $timeout, store, config) {
    ...
    $scope.init = function (req, res) {
        ...
        console.log("alpaca-portfolio-ctrl");
    ...
    $scope.alpacaportfolio = function(customerId) {
        $http.get(config.baseurl + "stockdata/alpacaportfolio/" + customerId  )
    ...
    $scope.deleteid = function(id) {
        ...
        console.log(id);
        $http.get(config.baseurl + 'stockdata/alpacaportfolio/del/' + id)
            .success(function(res) {
                if (res.status == 'false') {} else {
    ...
    $scope.editid = function(id,data) {
        console.log("edit id");
        console.log(id);
        $http.post(config.baseurl + 'stockdata/alpacaportfolio/edit', data)
            .success(function(res) {
                if (res.status == 'false') {} else {
