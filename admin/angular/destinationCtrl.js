app.controller('destinationCtrl', function($scope, $http, $window, $location, $sce, $timeout, store, config) {
    ...
    $scope.list = function(req, res) {
        ...
        $http.get(config.baseurl + 'destination/destinations/')
    ...
    $scope.add = function(req, res) {
        ...
        $http.post(config.baseurl + 'destination/create-destinations/', $scope.data)
            .success(function(res) {
                if (res.status == 'false') {
                    // Handle error
                } else {
    ...
    $scope.update = function(id) {
        ...
        $http.patch(config.baseurl + 'destination/destinations/' + id + '/', $scope.data)
            .success(function(res) {
                if (res.status == 'false') {
                    // Handle error
                } else {
    ...
    $scope.delete = function(id) {
        ...
        $http.delete(config.baseurl + 'destination/destinations/'+ id + '/')
