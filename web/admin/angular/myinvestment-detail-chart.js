            ...
            return function (scope, element, attrs) {
                attrs.$observe("data", function (newValue) { 
                    ...
                    var tooltipFormatter = function(sparkline, options, fields) {
                        ...
                        return '<span style="background-color: ' + background + '; padding: 5px; border-radius: 5px;">' + value + '</span>';
                    };
  ...
  function ($scope, $http, $window, $location, config, variable) {
    ...
    $scope.init = function (req, res) {
      ...
      var islogin = localStorage.getItem("islogin");
        ...
        jQuery("#modals").load("../modals.html");
        jQuery("#general").addClass("active");
        jQuery("#modelcategory").addClass("active");
        ...
        var urlconfig = {
          ...
          $http
            ...
            .success(function (response, status, headers, config) {
              ...
              console.log($scope.transactionsdata,"transactions data..")
            })
            .error(function (data, status, header, config) {
              console.log(data);
    ...
    $scope.portfolioStockList = function (req, res) {
      ...
      var portfolioId = searchParams.get('myportfolioId');
      $http
        ...
        .success(function (res) {
          if (res.status == "false") {
            ...
            $scope.mangoes = res;
            $scope.transactionsdata2 = $scope.mangoes.data;
            console.log($scope.transactionsdata2)
          }
        })
        .error(function () {});
    };
